 ...
 * @author alumno
 */
@WebServlet(name = "UnidadAcademica", urlPatterns = {"/UnidadAcademica"})
public class UnidadAcademicaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UnidadAcademicaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
