 ...
 * @author alumno
 */
@WebServlet(name = "NivelEditarServlet", urlPatterns = {"/NivelEliminar"})
public class NivelEliminarServlet extends HttpServlet {
    @EJB
    NivelEJB nivelEJB;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NivelPK nivel = new NivelPK(idEdificio,idNivel);
        nivelEJB.eliminar(nivel);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NivelEditarServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Eliminar Nivel</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
