 ...
 * @author alumno
 */
@WebServlet(name = "EdificioServlet", urlPatterns = {"/Edificio"})
public class EdificioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EdificioServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Ok edificio</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
